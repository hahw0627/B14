...
public class SkillUIManager : MonoBehaviour
{
    ...
    public static string GetRarityString(SkillRarity rarity)
    {
        switch (rarity)
        {
            case SkillRarity.Normal: return "�븻";
            case SkillRarity.Rare: return "����";
            case SkillRarity.Unique: return "����ũ";
            case SkillRarity.Epic: return "����";
            case SkillRarity.Legendary: return "��������";
            default: return "�� �� ����";
        }
    }
}