...
{    
#if UNITY_ANDROID
    private const string AD_UNIT_ID = "ca-app-pub-3940256099942544/5354046379"; // ��� ������ ���� �ֵ������ �����ϴ� �׽�Ʈ �� ID�� �־�� ��
#elif UNITY_IPHONE
  private string _adUnitId = "ca-app-pub-3940256099942544/1712485313";
    ...
    private void RegisterEventHandlers(RewardedAd ad)
    {
        ...
        ad.OnAdPaid += adValue =>
        {
            Debug.Log($"<color=#87ceeb>Rewarded ad paid {adValue.Value} {adValue.CurrencyCode}.</color>");
        };
        ...
        {
            Debug.Log("<color=#87ceeb>Rewarded ad full screen content opened.</color>");
        };
