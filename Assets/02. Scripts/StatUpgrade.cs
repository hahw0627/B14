...
public class StatUpgrade : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        SetupButton(HpBtn, () => UpgradeStat(ref PlayerData.MaxHp, 100, ref _maxHpCost, MaxHpTmp, "최대 체력 : ", HpCostTmp));
    ...
    private void UpdateUI()
    {
        ...
        HpCostTmp.text = _maxHpCost.ToString();
